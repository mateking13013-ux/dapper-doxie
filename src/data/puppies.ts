...
export const puppies: Puppy[] = [
  ...
  },
  {
    ...
    status: 'Available',
    price: 750,
    description: 'Sadie is a gentle soul with beautiful blue eyes and a mottled chocolate dapple coat. She is the peacemaker of the litter, always checking on her siblings. Sadie would be an ideal companion thanks to her calm and intuitive nature.',
  },
  {
    name: 'Zola',
    breed: 'Dachshund',
